...
class SellerController(
    ...
    ): SellerApplyResponse = sellerService.applySeller(UUID.fromString(userDetails.username), request)
    ...
    fun deleteProduct(
        ...
        sellerService.deleteProduct(UUID.fromString(userDetails.username), UUID.fromString(productId))
    }
    ...
    fun getReceivedOrders(
        ...
        sellerService.getReceivedOrders(UUID.fromString(userDetails.username), orderItemStatus, page, size)

    @GetMapping("/orders/summary")
    fun getOrderSummary(
        @AuthenticationPrincipal userDetails: UserDetails
    ): SellerOrderSummaryResponse = sellerService.getOrderSummary(UUID.fromString(userDetails.username))
    ...
    fun getOrderClaims(
        @AuthenticationPrincipal userDetails: UserDetails
    ): List<SellerOrderItemResponse> = sellerService.getOrderClaims(UUID.fromString(userDetails.username))

    @GetMapping("/dashboard/stats")
    fun getDashboardStats(
        @AuthenticationPrincipal userDetails: UserDetails
    ): SellerDashboardResponse = sellerDashboardService.getDashboard(UUID.fromString(userDetails.username))
    ...
    fun getTopProducts(
        ...
        sellerDashboardService.getTopProducts(UUID.fromString(userDetails.username), topN)
    ...
    fun getRecentOrders(
        ...
        sellerDashboardService.getRecentOrders(UUID.fromString(userDetails.username), page, size)
